...
public class EmailKit {
	...
	public static void sendSSLEmail(String emailServer, String fromEmail, String password, String toEmail, String title, String content){
		try {
			...
			transport.connect(emailServer, Integer.valueOf("465"), fromEmail, password);
...
//		boolean sendEmail465 = sendEmail465();
//		System.out.println(sendEmail465);
	}
}
